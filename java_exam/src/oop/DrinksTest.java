...
public class DrinksTest {
	public static void main(String[] args) {
		...
		DrinksArray drinkVendingMachine = new DrinksArray(bks, mst, hss, mks);
		
		drinkVendingMachine.countDrinks();
		int price = drinkVendingMachine.order(0, 10);
		System.out.println(price+"원");

		drinkVendingMachine.countDrinks();
		price = drinkVendingMachine.order(1, 20);
		System.out.println(price+"원");
		
		drinkVendingMachine.countDrinks();
		price = drinkVendingMachine.order(1, 10);
		System.out.println(price+"원");
		
		drinkVendingMachine.countDrinks();
		price = drinkVendingMachine.order(2, 8);
		System.out.println(price+"원");
				
		drinkVendingMachine.countDrinks();
		price = drinkVendingMachine.order(5, 8);
		System.out.println(price+"원");
